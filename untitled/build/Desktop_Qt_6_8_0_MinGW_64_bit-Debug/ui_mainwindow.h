...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_4 = new QGridLayout(fase1Exploracao);
        ...
        gridLayout_4->addWidget(fase1Exploracao_graphicsView, 0, 0, 1, 1);
        ...
        gridLayout_3 = new QGridLayout(fase1Batalha);
